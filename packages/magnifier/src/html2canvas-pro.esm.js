...
var Parser = /** @class */ (function () {
	...
	Parser.prototype.consumeSimpleBlock = function (type) {
		...
		while (true) {
			if (
				token.type === 32 /* TokenType.EOF_TOKEN */ ||
	...
	Parser.prototype.consumeFunction = function (functionToken) {
		...
		while (true) {
			...
			if (
				token.type === 32 /* TokenType.EOF_TOKEN */ ||
				token.type === 3 /* TokenType.RIGHT_PARENTHESIS_TOKEN */
			) {
				return cssFunction;
			}
			this.reconsumeToken(token);
...
var isDimensionToken = function (token) {
	return token.type === 15 /* TokenType.DIMENSION_TOKEN */;
};
...
var isStringToken = function (token) {
	return token.type === 0 /* TokenType.STRING_TOKEN */;
};
...
var nonFunctionArgSeparator = function (token) {
	return (
		token.type !== 31 /* TokenType.WHITESPACE_TOKEN */ &&
...
var isEndingTokenFor = function (token, type) {
	if (
		type === 11 /* TokenType.LEFT_CURLY_BRACKET_TOKEN */ &&
		token.type === 12 /* TokenType.RIGHT_CURLY_BRACKET_TOKEN */
	) {
		return true;
	}
	if (
		type === 28 /* TokenType.LEFT_SQUARE_BRACKET_TOKEN */ &&
		token.type === 29 /* TokenType.RIGHT_SQUARE_BRACKET_TOKEN */
	) {
		return true;
	}
	return (
...
var isLength = function (token) {
	return (
		token.type === 17 /* TokenType.NUMBER_TOKEN */ ||
		token.type === 15 /* TokenType.DIMENSION_TOKEN */
	);
};
...
var isRelativeTransform = function (tokens) {
	return (
		(tokens[0].type === 20 /* TokenType.IDENT_TOKEN */
			? tokens[0].value
			: 'unknown') === 'from'
	);
};
...
var packLab = function (_context, args) {
	...
	var _a = extractLabComponents(args),
		l = _a[0],
		a = _a[1],
		b = _a[2],
		alpha = _a[3],
...
var packOkLch = function (_context, args) {
	...
	var _a = extractOkLchComponents(args),
		l = _a[0],
		c = _a[1],
		h = _a[2],
		alpha = _a[3],
...
var packLch = function (_context, args) {
	...
	var _a = extractLchComponents(args),
		l = _a[0],
		c = _a[1],
		h = _a[2],
		a = _a[3],
...
var extractHslComponents = function (context, args) {
	var tokens = args.filter(nonFunctionArgSeparator),
		...
		alpha = tokens[3],
		h =
			(hue.type === 17 /* TokenType.NUMBER_TOKEN */
				? deg(hue.number)
...
var packHSL = function (context, args) {
	...
	var _a = extractHslComponents(context, args),
		h = _a[0],
		s = _a[1],
		l = _a[2],
		a = _a[3],
...
var extractLchComponents = function (args) {
	var tokens = args.filter(nonFunctionArgSeparator),
		...
		h =
			isNumberToken(tokens[2]) || isDimensionToken(tokens[2])
				? tokens[2].number
				: 0,
		a =
			typeof tokens[4] !== 'undefined' && isLengthPercentage(tokens[4])
				? getAbsoluteValue(tokens[4], 1)
				: 1;
	return [l, c, h, a];
};
var extractLabComponents = function (args) {
	var tokens = args.filter(nonFunctionArgSeparator),
		...
		l =
			tokens[0].type === 16 /* TokenType.PERCENTAGE_TOKEN */
				? tokens[0].number / 100
		...
		// eslint-disable-next-line prettier/prettier
		a =
			tokens[1].type === 16 /* TokenType.PERCENTAGE_TOKEN */
				? tokens[1].number / 100
...
var lab2xyz = function (lab) {
	var fy = (lab[0] + 16) / 116,
		...
		xyz = [
			...
			((fz > e ? Math.pow(fz, 3) : (116 * fz - 16) / k) *
				(1.0 - 0.3457 - 0.3585)) /
				0.3585
		];
...
var rgbToXyz = function (_context, args) {
	...
	if (tokens.length === 3) {
		var _a = tokens.map(getTokenColorValue),
			...
			_b = rgbLinear2xyz([rgb_linear[0], rgb_linear[1], rgb_linear[2]]),
			x = _b[0],
			y = _b[1],
			z = _b[2];
		return [x, y, z, 1];
	...
	if (tokens.length === 4) {
		var _c = tokens.map(getTokenColorValue),
			r = _c[0],
			g = _c[1],
			b = _c[2],
			a = _c[3],
			rgb_linear = rgb2rgbLinear([r / 255, g / 255, b / 255]),
			_d = rgbLinear2xyz([rgb_linear[0], rgb_linear[1], rgb_linear[2]]),
			x = _d[0],
			y = _d[1],
			z = _d[2];
		return [x, y, z, a];
...
var xyz50FromXYZ = function (args) {
	var _a = d65toD50([args[0], args[2], args[3]]),
		x = _a[0],
		y = _a[1],
		z = _a[2];
	return [x, y, z, args[3]];
...
var srgbFromXYZ = function (args) {
	var _a = srgbLinear2rgb(xyz2rgbLinear([args[0], args[1], args[2]])),
		r = _a[0],
		g = _a[1],
		b = _a[2];
	return [r, g, b, args[3]];
...
var srgbLinearFromXYZ = function (args) {
	var _a = xyz2rgbLinear([args[0], args[1], args[2]]),
		r = _a[0],
		g = _a[1],
		b = _a[2];
	return [
...
var p3LinearToXyz = function (p3l) {
	return multiplyMatrices(
		...
		[
			...
			0.2289745640697488, 0.6917385218365064, 0.079286914093745, 0.0,
...
var p3FromXYZ = function (args) {
	var _a = p3Linear2p3(xyzToP3Linear([args[0], args[1], args[2]])),
		r = _a[0],
		g = _a[1],
		b = _a[2];
	return [r, g, b, args[3]];
...
var a98FromXYZ = function (args) {
	var _a = a98Linear2a98(xyz2a98Linear([args[0], args[1], args[2]])),
		r = _a[0],
		g = _a[1],
		b = _a[2];
	return [r, g, b, args[3]];
...
var convertA98rgb = function (args) {
	var srgb_linear = xyz2rgbLinear(
		a98Linear2xyz(a982a98Linear([args[0], args[1], args[2]]))
	);
	return packSrgbLinear([
		srgb_linear[0],
		srgb_linear[1],
...
var proPhotoLinearToXyz = function (p3) {
	return multiplyMatrices(
		...
		[
			...
			0.2880748288194013, 0.711835234241873, 0.00008993693872564, 0.0, 0.0,
			0.8251046025104602
		],
		p3
	);
...
var xyzToProPhotoLinear = function (xyz) {
	return multiplyMatrices(
		...
		[
			...
			-0.5446307051249019, 1.5082477428451468, 0.02052744743642139, 0.0, 0.0,
			1.2119675456389452
		],
		xyz
	);
...
var proPhotoFromXYZ = function (args) {
	var _a = proPhotoLinearToProPhoto(
			xyzToProPhotoLinear(d65toD50([args[0], args[1], args[2]]))
		),
		r = _a[0],
		g = _a[1],
		b = _a[2];
...
var rec2020LinearToXyz = function (rec) {
	return multiplyMatrices(
		...
		[
			...
			0.2627002120112671, 0.6779980715188708, 0.05930171646986196, 0.0,
...
var rec2020FromXYZ = function (args) {
	var _c = rec2020Linear2rec2020(
			xyzToRec2020Linear([args[0], args[1], args[2]])
		),
		r = _c[0],
		g = _c[1],
		b = _c[2];
...
var _color = function (context, args) {
	...
	if (is_absolute) {
		...
		var c1 = isNumberToken(tokens[1]) ? tokens[1].number : 0,
				...
				for (var _i = 0, parts_1 = parts; _i < parts_1.length; _i++) {
					...
					expression +=
						part.type === 18 /* TokenType.FUNCTION */ && part.name === 'calc'
							...
							: isNumberToken(part)
							? part.number
							: part.type === 6 /* TokenType.DELIM_TOKEN */ ||
							  isIdentToken(part)
							? part.value
							: '';
				}
		...
		var from_colorspace =
				tokens[1].type === 18 /* TokenType.FUNCTION */
					? tokens[1].name
					: isIdentToken(tokens[1]) ||
					  tokens[1].type === 5 /* TokenType.HASH_TOKEN */
					? 'rgb'
					: 'unknown',
		...
		if (isIdentToken(tokens[1])) {
			...
			if (typeof named_color === 'undefined') {
				...
				var _c = parseColor(context, tokens[1].value),
					alpha = 0xff & _c,
					blue = 0xff & (_c >> 8),
					green = 0xff & (_c >> 16),
					red = 0xff & (_c >> 24);
		...
		var fromColorToXyz = SUPPORTED_COLOR_SPACES_TO_XYZ[from_colorspace],
		...
		var from_color = fromColorToXyz(context, from),
			from_final_colorspace = toColorFromXyz(from_color),
...
var linearGradient = function (context, tokens) {
	...
	parseFunctionArgs(tokens).forEach(function (arg, i) {
		if (i === 0) {
			...
			if (
				firstToken.type === 20 /* TokenType.IDENT_TOKEN */ &&
				firstToken.value === 'to'
			) {
...
function isSupportedImage(value) {
	return (
		!(
			value.type === 20 /* TokenType.IDENT_TOKEN */ && value.value === 'none'
		) &&
		(value.type !== 18 /* TokenType.FUNCTION */ ||
...
var backgroundImage = {
	...
	parse: function (context, tokens) {
		...
		var first = tokens[0];
		if (
			first.type === 20 /* TokenType.IDENT_TOKEN */ &&
			first.value === 'none'
		) {
			return [];
		}
...
var letterSpacing = {
	...
	parse: function (_context, token) {
		if (
			token.type === 20 /* TokenType.IDENT_TOKEN */ &&
			token.value === 'normal'
		) {
			return 0;
		}
...
var matrix = function (args) {
	var values = args
		.filter(function (arg) {
			return arg.type === 17 /* TokenType.NUMBER_TOKEN */;
		})
		.map(function (arg) {
			return arg.number;
		});
	...
	parse: function (_context, tokens) {
		return tokens
			...
			.filter(function (line) {
				return line !== 0 /* TEXT_DECORATION_LINE.NONE */;
			});
	}
};
...
var paintOrder = {
	...
	parse: function (_context, tokens) {
		var DEFAULT_VALUE = [
			0 /* PAINT_ORDER_LAYER.FILL */, 1 /* PAINT_ORDER_LAYER.STROKE */,
...
var CSSParsedDeclaration = /** @class */ (function () {
	...
	CSSParsedDeclaration.prototype.isVisible = function () {
		return (
			this.display > 0 &&
			this.opacity > 0 &&
			this.visibility === 0 /* VISIBILITY.VISIBLE */
		);
	};
	...
	CSSParsedDeclaration.prototype.isInlineLevel = function () {
		return (
			contains(this.display, 4 /* DISPLAY.INLINE */) ||
...
var loadSerializedSVG$1 = function (svg) {
	return new Promise(function (resolve, reject) {
		...
		img.onerror = reject;
		img.src = 'data:image/svg+xml;charset=utf-8,'.concat(
...
var breakWords = function (str, styles) {
	var breaker = LineBreaker(str, {
		...
		wordBreak:
			styles.overflowWrap === 'break-word' /* OVERFLOW_WRAP.BREAK_WORD */
				? 'break-word'
				: styles.wordBreak
	});
	var words = [];
...
var SVGElementContainer = /** @class */ (function (_super) {
	...
	function SVGElementContainer(context, img) {
		...
		_this.svg = 'data:image/svg+xml,'.concat(
...
var DocumentCloner = /** @class */ (function () {
	...
	DocumentCloner.prototype.toIFrame = function (ownerDocument, windowSize) {
		...
		documentClone.open();
		documentClone.write(
			''.concat(serializeDoctype(document.doctype), '<html></html>')
		);
					...
					if (counter && isIdentToken(counter)) {
						...
						var counterType_1 =
							counterStyle && isIdentToken(counterStyle)
								...
								: 3; /* LIST_STYLE_TYPE.DECIMAL */
						var separator =
							delim && delim.type === 0 /* TokenType.STRING_TOKEN */
								? delim.value
								: '';
...
var createPseudoHideStyles = function (body) {
	createStyles(
		...
		'.'
			.concat(PSEUDO_HIDE_ELEMENT_CLASS_BEFORE)
			.concat(PSEUDO_BEFORE)
			.concat(PSEUDO_HIDE_ELEMENT_STYLE, '\n         .')
			.concat(PSEUDO_HIDE_ELEMENT_CLASS_AFTER)
			.concat(PSEUDO_AFTER)
			.concat(PSEUDO_HIDE_ELEMENT_STYLE)
	);
...
var addBase = function (targetELement, referenceDocument) {
	...
	headEle === null || headEle === void 0
		? void 0
		: headEle.insertBefore(
				baseNode,
				(_a =
					headEle === null || headEle === void 0
						? void 0
						: headEle.firstChild) !== null && _a !== void 0
					? _a
					: null
		  );
};
				...
				switch (_a.label) {
					...
					case 2:
						this.context.logger.debug(
							'Added image '.concat(key.substring(0, 256))
						);
						return [
							4 /*yield*/,
	...
	Cache.prototype.proxy = function (src) {
		...
		return new Promise(function (resolve, reject) {
			...
			xhr.open(
				...
				''
					.concat(proxy)
					.concat(queryString, 'url=')
					.concat(encodeURIComponent(src), '&responseType=')
					.concat(responseType)
			);
			...
			if (_this._options.imageTimeout) {
				...
				xhr.ontimeout = function () {
					return reject(
						'Timed out ('.concat(timeout_1, 'ms) proxying ').concat(key)
					);
				};
			}
			xhr.send();
...
var TransformEffect = /** @class */ (function () {
	function TransformEffect(offsetX, offsetY, matrix) {
		...
		this.target =
			2 /* EffectTarget.BACKGROUND_BORDERS */ | 4 /* EffectTarget.CONTENT */;
	}
...
var isClipEffect = function (effect) {
	return effect.type === 1 /* EffectType.CLIP */;
};
var isOpacityEffect = function (effect) {
	return effect.type === 2 /* EffectType.OPACITY */;
};
...
var ElementPaint = /** @class */ (function () {
		...
		if (this.container.styles.overflowX !== 0 /* OVERFLOW.VISIBLE */) {
			...
			if (equalPath(borderBox, paddingBox)) {
				this.effects.push(
					new ClipEffect(
						borderBox,
						2 /* EffectTarget.BACKGROUND_BORDERS */ |
							4 /* EffectTarget.CONTENT */
					)
				);
			} else {
				this.effects.push(
					new ClipEffect(borderBox, 2 /* EffectTarget.BACKGROUND_BORDERS */)
				);
				this.effects.push(
					new ClipEffect(paddingBox, 4 /* EffectTarget.CONTENT */)
				);
			}
		}
	}
	ElementPaint.prototype.getEffects = function (target) {
		var inFlow =
			[2 /* POSITION.ABSOLUTE */, 3 /* POSITION.FIXED */].indexOf(
		...
		while (parent) {
			...
			if (
				inFlow ||
				parent.container.styles.position !== 0 /* POSITION.STATIC */ ||
				!parent.parent
			) {
				inFlow =
					[2 /* POSITION.ABSOLUTE */, 3 /* POSITION.FIXED */].indexOf(
...
var parseStackTree = function (
	...
	parent.container.elements.forEach(function (child) {
		var treatAsRealStackingContext = contains(
			child.flags,
			4 /* FLAGS.CREATES_REAL_STACKING_CONTEXT */
		);
		var createsStackingContext = contains(
			child.flags,
			2 /* FLAGS.CREATES_STACKING_CONTEXT */
		);
		var paintContainer = new ElementPaint(child, parent);
		if (contains(child.styles.display, 2048 /* DISPLAY.LIST_ITEM */)) {
			listItems.push(paintContainer);
		}
		var listOwnerItems = contains(child.flags, 8 /* FLAGS.IS_LIST_OWNER */)
			? []
			: listItems;
	...
	function CanvasRenderer(context, options) {
		...
		_this.context.logger.debug(
			'Canvas renderer initialized ('
				.concat(options.width, 'x')
				.concat(options.height, ') with scale ')
				.concat(options.scale)
		);
		return _this;
	}
	...
	CanvasRenderer.prototype.renderTextNode = function (text, styles) {
		return __awaiter(this, void 0, void 0, function () {
			...
			return __generator(this, function (_a) {
				...
				this.ctx.font = font;
				this.ctx.direction =
					styles.direction === 1 /* DIRECTION.RTL */ ? 'rtl' : 'ltr';
				...
				switch (_c.label) {
					...
					case 7:
						...
						this.context.logger.error(
							'Error loading image '.concat(container.src)
						);
						return [3 /*break*/, 8];
					case 8:
					...
					case 11:
						_c.sent();
						this.context.logger.error(
							'Error loading svg '.concat(container.svg.substring(0, 255))
						);
						return [3 /*break*/, 12];
					case 12:
						if (
					...
					case 14:
						...
						if (
							!contains(container.styles.display, 2048 /* DISPLAY.LIST_ITEM */)
						)
							return [3 /*break*/, 20];
					...
					case 17:
						_c.sent();
						this.context.logger.error(
							'Error loading list-style-image '.concat(url)
						);
						return [3 /*break*/, 18];
					case 18:
						return [3 /*break*/, 20];
					case 19:
						if (
							paint.listValue &&
							container.styles.listStyleType !== -1 /* LIST_STYLE_TYPE.NONE */
						) {
								...
								switch (_h.label) {
									...
									case 3:
										...
										this_1.context.logger.error(
											'Error loading background-image '.concat(url)
										);
										return [3 /*break*/, 4];
									case 4:
										if (image) {
											imageWidth =
												isNaN(image.width) || image.width === 0
													? 1
													: image.width;
											imageHeight =
												isNaN(image.height) || image.height === 0
													? 1
													: image.height;
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					...
					case 4:
						...
						return [3 /*break*/, 11];
					case 5:
						if (!((border.style === 3) /* BORDER_STYLE.DOTTED */))
							return [3 /*break*/, 7];
						return [
							4 /*yield*/,
							this.renderDashedDottedBorder(
					...
					case 6:
						...
						return [3 /*break*/, 11];
					case 7:
						if (!((border.style === 4) /* BORDER_STYLE.DOUBLE */))
							return [3 /*break*/, 9];
						return [
							4 /*yield*/,
	...
	function ForeignObjectRenderer(context, options) {
		...
		_this.context.logger.debug(
			'EXPERIMENTAL ForeignObject renderer initialized ('
				.concat(options.width, 'x')
				.concat(options.height, ' at ')
				.concat(options.x, ',')
				.concat(options.y, ') with scale ')
				.concat(options.scale)
		);
		return _this;
	}
	...
	Logger.prototype.debug = function () {
		...
		if (this.enabled) {
			...
			if (
				...
				console.debug.apply(
					console,
					__spreadArray([this.id, ''.concat(this.getTime(), 'ms')], args, false)
				);
			} else {
				...
				case 0:
					...
					context.logger.debug(
						'Starting document clone with size '
							.concat(windowBounds.width, 'x')
							.concat(windowBounds.height, ' scrolled to ')
							.concat(-windowBounds.left, ',')
							.concat(-windowBounds.top)
					);
				...
				case 3:
					context.logger.debug(
						'Document cloned, element located at '
							.concat(left, ',')
							.concat(top, ' with size ')
							.concat(width, 'x')
							.concat(height, ' using computed rendering')
					);
					...
					context.logger.debug(
						'Starting renderer for element at '
							.concat(renderOptions.x, ',')
							.concat(renderOptions.y, ' with size ')
							.concat(renderOptions.width, 'x')
							.concat(renderOptions.height)
					);
